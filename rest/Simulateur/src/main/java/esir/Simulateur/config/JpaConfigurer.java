package esir.Simulateur.config;
...
import esir.Simulateur.support.jpa.CustomRepositoryFactoryBean;
import esir.Simulateur.support.jpa.SpringSecurityAuditorAware;
import esir.Simulateur.web.entity.User;
...
@Configuration
@EnableJpaRepositories(basePackages = "esir.Simulateur.web.repository", repositoryFactoryBeanClass = CustomRepositoryFactoryBean.class)
// @EnableJpaRepositories(basePackages =
// "esir.Simulateur.web.repository",
